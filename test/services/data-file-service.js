...
describe('data-file-service', function() {
  ...
  describe('processData', function() {
    ...
    it('Expect environmentMock.buildEnvironment called', function() {
    ...
    it('Expect environmentMock.replaceVariables called twice', function() {
      dataFileService.processData(dataFileJson).then(function() {
    ...
    it('Expect recordServiceMock.insertRecords called twice', function() {
      dataFileService.processData(dataFileJson).then(function() {
    ...
    it('Expect promise rejection when buildEnvironment rejects', function() {
      environmentMock.buildEnvironment.reset().rejects('this is an error');
      dataFileService.processData(dataFileJson).then(function() {
        expect(false).to.be.true;
      }, function(reason) {
        expect(reason).to.be.equal('this is an error');
    ...
    it('Expect promise rejection when insertRecords rejects', function() {
  ...
  describe('cleanData', function() {
    ...
    it('Expect all cleaner objects run from data file', function() {
      dataFileService.cleanData(dataFileJson.cleaners).then(function() {
        expect(executeMock.calledTwice()).to.be.true;
      });
    });

    it('Expect promise rejection when executeMock rejects', function() {
