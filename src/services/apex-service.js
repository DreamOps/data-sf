 ...
 * @param {connection-service} login - Dependency on the connection-service provided.
...
module.exports = function(login, promise, util, logger) {
  ...
  * @return Promise that resolves with the execution result when the execution finishes.
  */
